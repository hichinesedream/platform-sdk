 ...
 * @version    1.0.0 2016-03-30 15:53:02
 */

class Touzhijia_Platform_Entity_QueryUserReq extends Touzhijia_Platform_Entity_BaseMsg
{
	...
	public function reset()
	{
		$this->_arrMsg = array(
				...
				'body'    => array(
					...
					"index" => array(
						"name"     => null,	// string, 查询字段，本版本固定为：username

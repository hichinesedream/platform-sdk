...
4 | 3.6 投资记录查询：Response | 新增：<br />"investAt": "datetime, 投资时间"<br />"period": "string, 实际投资期限, 1d, 1m"<br />"interestAt": "datetime, 起息时间"<br />"investRate": "float, 投资利率"<br />删除：<br />"investAt": "datetime, 投资时间"
5 | 3.7 回款记录查询：Response | 新增：<br />"usernamep": "string, 合作平台用户名"<br />"createTime": "string, 回款计划生成时间"<br />"repayPlan": "array, 回款计划明细"<br />"expectAmount": "float, 预期回款金额(本金)"<br />"expectIncome": "float, 预期回款金额(本金)"<br />"repayDate": "datetime, 实际回款时间"<br />"status": "enum，回款状态，见回款状态表格"<br />删除：<br />"id": "string, 回款ID，全局唯一"
